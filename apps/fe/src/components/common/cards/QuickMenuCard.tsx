...
const QuickMenuCard = ({ label, imageSrc, icon, onClick }: QuickMenuCardProps) => {
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex h-[90px] w-full min-w-0 flex-col items-center justify-center gap-x1-5 overflow-hidden rounded-[var(--radius-r2)] bg-gray-100 px-3 py-3 text-center font-sans"
    >
