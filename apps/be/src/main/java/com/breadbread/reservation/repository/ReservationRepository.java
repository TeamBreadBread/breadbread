...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
    ...
    List<Reservation> findAllByUserIdAndStatusOrderByCreatedAtDesc(Long userId, ReservationStatus status);
    boolean existsByUserIdAndDepartureDateAndDepartureTimeAndStatusIn(
            Long userId, LocalDate departureDate, LocalTime departureTime, Collection<ReservationStatus> statuses);
    boolean existsByUserIdAndDepartureDateAndDepartureTimeAndStatusInAndIdNot(
            Long userId, LocalDate departureDate, LocalTime departureTime, Collection<ReservationStatus> statuses, Long id);
