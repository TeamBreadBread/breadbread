...
public class AiCourseRequest {
    ...
    @NotNull
    @Schema(
            description = "여행 유형 (ALONE: 혼자, COUPLE: 커플, FRIENDS: 친구, FAMILY: 가족)",
            example = "COUPLE")
    ...
    @Schema(
            description =
                    "예산 (UNDER_20000: 2만원 이하, BETWEEN_20000_40000: 2~4만원, OVER_40000: 4만원 이상, ANY: 상관없음)",
            example = "BETWEEN_20000_40000")
    ...
    @NotEmpty
    @Schema(
            description = "선호 빵 종류 (BREAD, SANDWICH, CAKE, RICE_CAKE, COOKIE, DIET)",
            example = "[\"BREAD\", \"CAKE\"]")
    ...
    @NotNull
    @Schema(
            description = "코스 유연성 (MAINTAIN: 계획 유지, ACTIVE: 적극 변경, SOLDOUT_ONLY: 품절 시만 변경)",
            example = "SOLDOUT_ONLY")
