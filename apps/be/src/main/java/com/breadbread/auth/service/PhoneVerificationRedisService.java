...
public class PhoneVerificationRedisService {
    ...
    public void savePending(
            String phone, VerificationPurpose purpose, String code, long ttlSeconds) {
        PhoneVerificationCache value =
    ...
    public Optional<PhoneVerificationCache> findByPhoneAndPurpose(
    ...
    public void markVerified(
        ...
        PhoneVerificationCache current =
                findByPhoneAndPurpose(phone, purpose)
                        .orElseThrow(() -> new CustomException(ErrorCode.VERIFICATION_NOT_FOUND));

        PhoneVerificationCache verifiedValue =
                PhoneVerificationCache.builder()
        ...
        stringRedisTemplate
                .opsForValue()
                .set(tokenKey, phoneKey, Duration.ofSeconds(verifiedTtlSeconds));
